...
TOKEN = "7629892524:AAE2o--rQEO6x8cuLns-KJ1p6hKq5rGSkls"  
...
FACTS = [
    ...
    "Среднее облако весит порядка 500 тонн, как 80 слонов!",
    "В мире всего 7% левшей!",
    "Страусы развивают скорость до 70 км/ч",
    "У кошки падающей с 12 этажа, больше шансов выжить, чем с 7-ого этажа"   
]
...
WEATHER = {
    ...
    "сочи": "🌊 +28°C, жара",
    "спб": "🌧 +18°C, дождь",
    "хабаровск": "📍+16°C, дождь",
    "лос-анджелес": "+22°C, солнечно🔆",
    "пхукет": "+28°C, облачно🆒",
    "сингапур": "+27°C, солнечно",
    "владивосток":"+16°C, ветрено💨"
}
MOODS = {
    "happy": {
        "state": "😊 Радостный",
        "phrases": ["Отлично!", "Я счастлив", "Все прекрасно"]
    },
    "neutral": {
        "state": "😐 Нейтральный",
